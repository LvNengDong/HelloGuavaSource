 ...
 * @since 15.0
 * @deprecated Use {@link Traverser} instead. All instance methods have
...
public abstract class TreeTraverser<T> {
   ...
   *
   * @since 20.0
   * @deprecated Use {@link Traverser#forTree} instead. If you are using a
   ...
   *
   * @deprecated Use {@link Traverser#depthFirstPreOrder} instead, which has
   *     the same behavior.
   */
  @Deprecated
   ...
   * is in progress or when the iterators generated by {@link #children} are advanced.
   *
   * @deprecated Use {@link Traverser#depthFirstPostOrder} instead, which
   ...
   * is in progress or when the iterators generated by {@link #children} are advanced.
   *
   * @deprecated Use {@link Traverser#breadthFirst} instead, which has the
   *     same behavior.
   */
  @Deprecated
